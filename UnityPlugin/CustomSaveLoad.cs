...
public class ArchiSaver:JSONsaver {
    ...
    private void ProcessItem(string itemName) {
        ...
        if(Plugin.instance.customSaveLoad.cfgOnlyActiveDrops.Value <= 0f || Time.unscaledTime - ArchipelagoClient.lastConnectTime > Plugin.instance.customSaveLoad.cfgOnlyActiveDrops.Value)
